...
export const queuedUsers = state => state.users.queued;
export const queuedUsersList = createSelector(queuedUsers, (usersById = {}) => {
	const users = Object.keys(usersById).map(id => usersById[id]);
	return users || [];
});
