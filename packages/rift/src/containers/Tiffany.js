	...
	render() {
		...
		const question2 = (
			<React.Fragment>
				<Layout style={trueStyle('row')}>
					<Text style={trueStyle('text')} category="h2">
						What is the smallest positive integer that occurs infinitely often as the
					...
					<Text style={trueStyle('text')} category="h2">
						That number will connect that many NA's together. eg. 1 = na, 3 = nanana
					</Text>
				</Layout>
				<Layout style={trueStyle('row')}>
					<Input
						...
						onChangeText={text => {
							return this.setValue('2', text);
						}}
						keyboardType="number-pad"
					/>
				</Layout>
				<Layout style={trueStyle('row')}>
					<Text style={trueStyle('text')} category="h3">
						{repeatedNa}{' '}
					</Text>
				</Layout>
			</React.Fragment>
		...
		const nextQuestions = () => {
			...
			if (
				ans3 &&
				ans3.value &&
				typeof ans3.value == 'string' &&
				/yo/i.test(ans3.value)
			) {
				onCompletedAnswers = (
					<Layout style={trueStyle('row')}>
						<Text style={trueStyle('text')} category="h1">
							NOW PUT IT TOGETHER!!!{' '}
						</Text>
						<Fireworks {...fxProps} />
						<Layout style={trueStyle('row')}>
		...
		return (
			<Layout style={trueStyle('container')}>
				<Layout style={trueStyle('row')}>
					<Text style={trueStyle('text')} category="h2">
						Hello, my love. I've always been told its the thought that counts. So
						here's all my thoughts! Hope you aren't salty its late{' '}
					</Text>
				</Layout>
				<Layout style={trueStyle('row')}>
					<Text style={trueStyle('text')} category="h2">
						What is a metal that is commonly combined with an electrolyte?{' '}
					</Text>
				</Layout>
				...
				<Layout style={trueStyle('row')}>
					<Text style={trueStyle('text')} category="h6">
						Fe, that's iron, but the answer isn't!
					</Text>
				</Layout>
				{toMap}
			</Layout>
